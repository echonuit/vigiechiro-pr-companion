...
| A2 · Un garde est vu rouge sur sa propre mutation | 12 | 8 | `src/test/bats/cli.bats`, `src/test/java/fr/univ_amu/iut/architecture/AnnonceDesMutationsTest.java`, `.github/scripts/mesure_duree_portail.py`, et 4 autres |
...
| A4 · Un cas joué n'est pas un cas prouvé | 25 | 16 | `ApercuFxElisionTest#bouton_tronque_refuse`, `ActiviteViewTest#l_export_image_redessine_un_graphe_reellement_dessine`, `scripts/adr/3053-capture-libelle.py`, et 13 autres |
...
| A9 · La dette se tient par un cliquet, pas par un nettoyage | 16 | 8 | `scripts/adr/2843-tiret-cadratin.py`, `PatronDuCliquetTest#tout_cliquet_passe_par_le_patron`, `scripts/adr/verifie_scripts.py`, et 11 autres |
...
| A12 · Rendre compte avant de conclure, et aucun échec silencieux | 10 | 6 | `scripts/adr/0008-echec-silencieux.py`, `.github/scripts/verifie_secret_winget.py`, `RetourOperationTest#les_deux_causes_ne_se_melangent_pas`, et 8 autres |
