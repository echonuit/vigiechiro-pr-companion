...
| A3 · Un dispositif dit ce qu'il couvre, et ce qu'il n'a pas pu lire | 37 | 29 | `.github/scripts/veille_contrat_api.py`, `AnalyseViewTest#colonne_commune_sur_la_table_des_observations`, `SiteEditRechercheCarreTest#un_verdict_arrive_en_retard_est_ecarte`, et 28 autres |
...
| A6 · La vérification se déclare, sur trois niveaux | 4 | 3 | `DocumentationAJourTest#la_verification_declaree_par_une_adr_existe_vraiment`, `EcritureAtomiqueTest#creation_restreinte`, `scripts/adr/verifie_okf.py` |
...
| A11 · L'assumé se déclare, il ne se contourne pas | 14 | 0 | `scripts/adr/verifie_verdicts_declares.py` |
...
| A19 · Toute capacité métier est offerte aussi en ligne de commande | 6 | 4 | `ArchitectureTest#lecture_brute_reservee_au_groupe_api`, `ExportSyntheseCsvTest#referentiel_indisponible_conserve_les_colonnes`, `FiltresActiviteTest#ce_qui_qualifie_rend_vide_sans_refuser`, et 1 autre |
