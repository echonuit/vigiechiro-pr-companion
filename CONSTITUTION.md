...
| A9 · La dette se tient par un cliquet, pas par un nettoyage | 12 | 4 | `scripts/adr/2843-tiret-cadratin.py`, `PatronDuCliquetTest#tout_cliquet_passe_par_le_patron`, `scripts/adr/verifie_scripts.py`, et 8 autres |
