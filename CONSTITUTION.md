...
|---|---:|---:|---|
| A1 · La preuve précède l'affirmation | 3 | 1 | `.github/scripts/verifie-decisions-du-tournage-connecte.sh`, `.github/scripts/verifie-jeton-vivant.sh`, `.github/scripts/revoque-jeton.sh` |
...
| A17 · Ne rien inventer, ne rien effacer, n'écrire que ce qui est déclaré | 25 | 20 | `MoteurTraitementGroupeTest#annulation_apres_le_passage_courant`, `RestaurationCompleteTest#restauration_sur_une_autre_machine`, `EmpreinteMigrationsTest#script_modifie_apres_coup_fait_refuser`, et 31 autres |
