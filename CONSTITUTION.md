...
| A3 · Un dispositif dit ce qu'il couvre, et ce qu'il n'a pas pu lire | 19 | 17 | `.github/scripts/veille-contrat-api.sh`, `AnalyseViewTest#colonne_commune_sur_la_table_des_observations`, `SiteEditRechercheCarreTest#un_verdict_arrive_en_retard_est_ecarte`, et 17 autres |
...
| A9 · La dette se tient par un cliquet, pas par un nettoyage | 11 | 4 | `scripts/adr/2843-tiret-cadratin.py`, `PatronDuCliquetTest#tout_cliquet_passe_par_le_patron`, `scripts/adr/verifie_scripts.py`, et 7 autres |
