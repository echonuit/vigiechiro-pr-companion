...
|---|---:|---:|---|
| A1 · La preuve précède l'affirmation | 2 | 1 | `.github/scripts/verifie-decisions-du-tournage-connecte.sh`, `.github/scripts/verifie-jeton-vivant.sh`, `.github/scripts/revoque-jeton.sh` |
...
| A3 · Un dispositif dit ce qu'il couvre, et ce qu'il n'a pas pu lire | 14 | 13 | `.github/scripts/veille-contrat-api.sh`, `AnalyseViewTest#colonne_commune_sur_la_table_des_observations`, `SiteEditRechercheCarreTest#un_verdict_arrive_en_retard_est_ecarte`, et 11 autres |
...
| A9 · La dette se tient par un cliquet, pas par un nettoyage | 9 | 4 | `scripts/adr/2843-tiret-cadratin.py`, `PatronDuCliquetTest#tout_cliquet_passe_par_le_patron`, `scripts/adr/verifie_scripts.py`, et 6 autres |
...
| A17 · Ne rien inventer, ne rien effacer, n'écrire que ce qui est déclaré | 23 | 18 | `MoteurTraitementGroupeTest#annulation_apres_le_passage_courant`, `RestaurationCompleteTest#restauration_sur_une_autre_machine`, `EmpreinteMigrationsTest#script_modifie_apres_coup_fait_refuser`, et 22 autres |
