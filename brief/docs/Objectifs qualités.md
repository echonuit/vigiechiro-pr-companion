...
Les critères de la qualité logicielle traduisent l'appréciation d'une application informatique au travers d'un référentiel partagé. Ce référentiel peut différer suivant les standards retenus et évolue avec le temps.

Les normes **ISO/IEC 9126** puis **ISO/IEC 25010** définissent un ensemble de critères qui font office de standard à l'heure actuelle. Ces critères permettent à la fois de partager un vocabulaire commun et de baliser le périmètre de la qualité logicielle. Maîtriser leur signification est un travail préalable indispensable à toute mise en place d'un processus qualité.
