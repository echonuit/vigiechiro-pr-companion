...
Aucun objectif explicite dans la liste actuelle, mais ce scénario soutient indirectement [O2 - Facilité d'apprentissage](../Objectifs%20qualites/O2.md) (apprentissage facilité dans la langue maternelle de l'utilisateur).
