...
- **CLI (<!--inv:cli-->71<!--/inv--> sous-commandes)** : l'application expose une ligne de commande `vigiechiro <sous-commande>` couvrant l'équivalent de l'IHM (import, qualification, validation, dépôt, traitement serveur, publication, sauvegarde, audit, diagnostic, reconstruction, synthèse d'une nuit...), pour le scripting et l'automatisation sur gros volume. La **parité CLI ↔ IHM** est une contrainte de conception.
