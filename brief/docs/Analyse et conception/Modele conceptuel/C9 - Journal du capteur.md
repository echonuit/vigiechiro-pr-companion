...
|---|---|---|---|
| chemin sur disque | texte | obligatoire | Fichier `LogPR<n>.txt` à la racine de la session d'enregistrement (cf. [R22](Regles%20metier.md#r22)). |
...
- [R19](Regles%20metier.md#r19) - journal circulaire, l'application exploite ce qui est présent sans tenter de reconstituer les pertes.
