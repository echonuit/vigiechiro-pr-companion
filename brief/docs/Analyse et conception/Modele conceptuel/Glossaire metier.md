...
Vocabulaire utilisateur posé dans le modèle conceptuel. Ces termes sont **ceux qui apparaissent dans l'IHM** ; on évite à dessein le jargon technique pour rester lisible par les utilisateurs cibles (cf. [O2 - Facilité d'apprentissage](../../Objectifs%20qualites/Objectifs%20qualites/O2.md)).
...
| **Campagne** | Regroupement **facultatif** de passages relevant du même suivi. Sert à retrouver et à piloter un sous-ensemble de nuits ; n'entre dans aucune règle de protocole. | « Suivi ENS 2026 ». Un observateur peut utiliser toute l'application sans jamais en créer une. |
| **Participation opportuniste** | Nuit bien enregistrée, mais **hors du protocole** de l'observateur : elle ne compte pas comme passage 1 ou 2, et les contrôles de fenêtre et d'intervalle ([R3](Regles%20metier.md#r3), [R4](Regles%20metier.md#r4)) sont muets pour elle. | Une nuit réalisée sur le carré d'un collègue. Se déclare à l'import, dans la modale du passage, ou se dérive d'un **carré d'un tiers**. |
| **Carré d'un tiers** | Carré que Vigie-Chiro rattache à un **autre observateur** que celui connecté. Il sort du solde de saison, et ses nuits sont présumées opportunistes. | Marie participe à une nuit sur le carré de son association : le carré reste celui de l'association. |
...
| **Workspace** | Dossier racine sur le disque local de l'utilisateur où vivent toutes les sessions d'enregistrement, la base SQLite et les réglages. Configurable depuis les préférences (cf. [R21](Regles%20metier.md#r21)). | Défaut : `<Documents>/VigieChiro-Companion/`. Pour gros volumes, pointer un disque externe. |
...
| **Durée enregistrée** | Durée **réelle** captée par l'enregistreur sur un passage : la somme des durées des séquences d'écoute, comptées en secondes réelles (5 s par séquence pleine). À ne pas confondre avec la durée d'**écoute**, qui vaut ×10. | Une nuit de 2 109 séquences : 1 h 58 min enregistrées, mais environ 19 h 35 à réécouter intégralement. |
