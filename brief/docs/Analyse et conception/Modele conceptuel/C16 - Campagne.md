...
> **Objet purement organisationnel.** La campagne n'entre dans **aucune** règle métier : elle ne conditionne ni le rattachement d'un passage, ni les fenêtres [R3](Regles%20metier.md#r3) / [R4](Regles%20metier.md#r4), ni le dépôt. Supprimer une campagne **détache** ses passages, elle n'en efface aucun.
