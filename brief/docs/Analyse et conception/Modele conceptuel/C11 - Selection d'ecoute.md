...
| verdict par séquence | énum × M | saisi | `Bon` / `Mauvais` / `Inexploitable` pour chaque fichier son écouté ([R13](Regles%20metier.md#r13)). Alimente la **barre de progression tricolore** et **dérive** le verdict final du passage. |

## Règles applicables

- [R12](Regles%20metier.md#r12) - sélection auto à l'ouverture (méthode `RéparTemporel` par défaut).
- [R13](Regles%20metier.md#r13) - verdict par fichier son saisi par l'utilisateur (verdict final du passage dérivé, surchargeable), sans seuil obligatoire d'écoute.
...
- **Porte sur** 1..N [Séquences d'écoute](C8%20-%20Sequence%20d%27ecoute.md).
