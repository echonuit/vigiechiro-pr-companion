...
- **Complétude de la nuit** (`lblNuitInterrompue`, #5093) : **second encart**, sous le précédent, qui dit ce que le **journal du capteur** rapporte de la fin de la nuit. C'est un **axe distinct** de la cohérence horaire, et non un troisième niveau de couverture : une nuit peut couvrir la fenêtre exigée **et** s'être interrompue en son milieu, et les deux encarts se lisent alors côte à côte. Il se tait quand le journal ne couvre pas la nuit, son silence ne prouvant pas qu'elle fut entière ([ADR 5093](https://companion-dev.echonuit.fr/decisions/5093-la-couverture-et-la-completude-sont-deux-axes/)).
