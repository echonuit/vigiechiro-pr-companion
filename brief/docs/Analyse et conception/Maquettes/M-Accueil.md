...
- **Tableau de bord** : quatre compteurs chiffrés (**Sites**, **Points d'écoute**, **Passages**, **Observations**), chacun avec sa pastille d'icône colorée. Les valeurs sont **recalculées à chaque révision des données** : elles suivent la base, pas les déplacements de l'utilisateur, et changent donc sous ses yeux si un import ou une synchronisation écrit pendant qu'il est sur l'accueil. Le bandeau est **masqué tant qu'aucune donnée** n'existe (premier lancement).
...
## La carte ajoutée par le chantier #2349

- Une carte **« Ma saison »** a rejoint le prisme *Collecte & passages*, au rang qui suit
...
L'accueil porte donc **sept cartes** réparties sur deux prismes, plus le bandeau de compteurs. Le
prisme *Collecte & passages* en compte quatre, le prisme *Espèces & biodiversité* trois.
