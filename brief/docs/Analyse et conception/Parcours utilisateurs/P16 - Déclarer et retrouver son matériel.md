...
[C4 - Enregistreur](../Modèle%20conceptuel/C4%20-%20Enregistreur.md) mémorise l'identité du détecteur
« pour suivre la santé du matériel dans le temps » et a produit `1..N` passages ;
[C4bis - Micro](../Modèle%20conceptuel/C4bis%20-%20Micro.md) est porté par un enregistreur, modifiable,
