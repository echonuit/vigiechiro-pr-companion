...
[🖼️ Voir le diagramme en plein écran ↗](P0%20-%20plein%20ecran.md){ .md-button }
...
→ **Détail complet** : [P1 - Déclarer un site de suivi](P1%20-%20Declarer%20un%20site%20de%20suivi.md).
...
→ **Détail complet** : [P3 - Vérifier l'enregistrement par échantillonnage](P3%20-%20Verifier%20l%27enregistrement%20par%20echantillonnage.md).
...
→ **Détail complet** : [P4 - Préparer le dépôt](P4%20-%20Preparer%20un%20lot%20pret%20a%20deposer.md).
...
- La durée totale entre l'insertion de la SD et le clic « J'ai déposé » reste **acceptable pour une nuit standard de quelques Go** (cf. [O3](../../Objectifs%20qualites/Objectifs%20qualites/O3.md)).
...
24-48 h après le dépôt, Marie recevra un fichier de résultats Tadarida sur le portail Vigie-Chiro. La validation de ces résultats est documentée comme **cible étirable** - voir [P7 - Valider les résultats Tadarida](P7%20-%20Valider%20les%20resultats%20Tadarida.md).
