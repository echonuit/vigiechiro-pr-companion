...
- **La fin de dépôt ne rend PAS encore de comptes en chiffres** *(reste à faire, clôture de l'EPIC #2350)*. Le lot 2 a branché l'import, la réactivation et la **publication des corrections** ; le téléversement de la nuit, lui, rend toujours son bilan dans un **bandeau d'une ligne**, à côté de sa table de suivi par fichier. Le brancher demande de trancher une question que ce lot n'a pas tranchée : la bande et la table diraient en partie la même chose, et il faut décider laquelle porte quoi. Voir [M-CompteRendu](../Maquettes/M-CompteRendu.md).
