...
| **Participation opportuniste** | Nuit bien enregistrée, mais **hors du protocole** de l'observateur : elle ne compte pas comme passage 1 ou 2, et les contrôles de fenêtre et d'intervalle ([R3](Règles%20métier.md#r3), [R4](Règles%20métier.md#r4)) sont muets pour elle. | Une nuit réalisée sur le carré d'un collègue. Se déclare à l'import, dans la modale du passage, ou se dérive d'un **carré d'un tiers**. |
