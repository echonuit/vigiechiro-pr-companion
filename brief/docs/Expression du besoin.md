...
Le tableau ci-dessous décrit la structure du **full dataset**, conforme à [R22](Analyse%20et%20conception/Modele%20conceptuel/Regles%20metier.md#r22) ; l'échantillon suit la même arborescence avec un sous-ensemble des fichiers audio.
...
| `bruts/` | 1572 fichiers WAV originaux ([C7](Analyse%20et%20conception/Modele%20conceptuel/C7%20-%20Enregistrement%20original.md)), format `Car<carre>-<annee>-<passage>-<zone>-PaRecPR<sn>_<AAAAMMJJ>_<HHMMSS>.wav` (ex. `Car640380-2026-Pass2-Z1-PaRecPR1925492_20260422_202623.wav`). Mono 16 bits 384 kHz. Durée variable (2 à 30 s, déclenchement sur seuil). |
| `transformes/` | 2109 séquences d'écoute ([C8](Analyse%20et%20conception/Modele%20conceptuel/C8%20-%20Sequence%20d%27ecoute.md)) : les WAV bruts **renommés, découpés en séquences de 5 s et ralentis ×10** (suffixe `_000`, `_001`...) + 2 CSV d'observations Tadarida ([C12](Analyse%20et%20conception/Modele%20conceptuel/C12%20-%20Resultats%20d%27identification.md), cf. [R23](Analyse%20et%20conception/Modele%20conceptuel/Regles%20metier.md#r23)). C'est cette version, prête au dépôt sur Vigie-Chiro, que Tadarida analyse. |
...
- **Déclarer un site de suivi** dans l'application : n° de carré (6 chiffres) et codes des points d'écoute (1 lettre + 1 chiffre). Le site doit avoir été créé en amont sur le portail Vigie-Chiro, qui seul peut recevoir un dépôt. Le **n° de carré**, lui, n'a plus à y être relevé : depuis #4573, l'application le déduit d'une position collée depuis une carte, et le carroyage national étant embarqué, ce geste marche hors connexion.
...
- le [modèle conceptuel](Analyse%20et%20conception/Modele%20conceptuel/index.md) - vocabulaire et données
