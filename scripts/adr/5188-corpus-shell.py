...
49 est la mesure du jour, pas un objectif. Elle etait de 50 : `verifie-chantier-de-l-issue.sh` a ete converti par #5210. Un cliquet ne se negocie pas vers le haut : chaque
