# declaration-de-carre Specification
...
**Vérifié par** : `PositionColleeViewModelTest#situer_propose_le_carre`,
`ModaleSiteViewTest#situer_une_position_remplit_le_carre`, `SiteEditSituerPositionTest#situer_depose_le_carre`,
et le parcours `ParcoursDeclarerSiteE2ETest` qui traverse la couture jusqu'au site créé.
...
**Vérifié par** : `PropositionCarreTest#position_interieure_propose_son_carre` et
`#hors_metropole_le_dit` hors ligne, et la sonde de contrat live
`ContratApiVigieChiroLiveTest#grille_stoc_hors_grille_rend_une_reponse_vide` contre le serveur réel.
...
**Vérifié par** : `PositionColleeViewModelTest#remplacement_nomme_ce_qu_il_ecrase` et
`#confirmation_se_dit`.
...
**Vérifié par** : `ModaleSiteViewTest#situer_ne_depend_pas_de_la_connexion` et
`SiteEditSituerPositionTest#situer_n_interroge_pas_la_plateforme`, nommés par
l'[ADR 4577](../../../../dev-docs/decisions/4577-le-carre-d-une-position-se-calcule-hors-ligne.md).
...
**Vérifié par** : `ReponsesVigieChiroTest#numero_carre_stoc_rembourre_le_zero_de_gauche` et
`#numero_carre_stoc_laisse_six_chiffres_intacts`, `NumeroDeCarreTest#departement_a_un_chiffre_retrouve_son_zero`,
et l'[ADR 4576](../../../../dev-docs/decisions/4576-le-format-r1-se-retablit-a-l-entree-pas-au-point-de-comparaison.md)
qui tient la règle à l'entrée.
...
**Vérifié par** : `PropositionCarreTest#frontiere_nomme_sans_choisir`, `#coin_nomme_les_quatre`,
`#second_carre_indiscernable_rend_frontalier` et `#second_carre_nettement_plus_loin_ne_gene_pas` ;
`CarroyageNationalTest#milieu_d_un_cote_rend_deux_candidats` pour la mesure ;
`ModaleSiteViewTest#situer_sur_une_frontiere_ne_remplit_rien` à l'écran. Le seuil vit dans
`BandeDesIndiscernables.POUR_PROPOSER` ([ADR 4610](../../../../dev-docs/decisions/4610-deux-seuils-d-indiscernabilite-parce-que-l-erreur-ne-coute-pas-la-meme-chose.md)).
