---
type: adr
title: "La réactivation se vérifie par une cascade de preuves ; « archivé » est un état observé, pas un statut"
status: stable
article: A15
chantier: "EPIC #1297 (passage archivé) ; cascade #1309, empreinte #1299"
verification: certaine
enforced_by:
  - "DecisionsRespecteesTest#archive_n_est_pas_un_statut_de_workflow"
verified:
  - by: machine:ci
---

# La réactivation se vérifie par une cascade de preuves ; « archivé » est un état observé, pas un statut
