...
| `ajouter-point` | `--site <id> --code <c> [--lat ..] [--lon ..] [--description ..]` | A10 | `ServiceSites.ajouterPoint`. Avec une position, **contrôle le carré du site hors ligne** (#4682) : une divergence part sur **stderr**, l'identifiant du point reste seul sur stdout et le code de sortie ne change pas - `POINT=$(vigiechiro ajouter-point ...)` continue de marcher |
