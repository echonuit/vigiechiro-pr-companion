...
| `scripts/methode/matrice-constitution.py` | la matrice de `CONSTITUTION.md` concorde avec les en-têtes des ADR, et **nomme les articles que rien ne tient** : c'est la liste des gardes qui restent à écrire | `lint.yml` |
