...
| `scripts/methode/matrice-constitution.py` | la matrice de [CONSTITUTION.md](../CONSTITUTION.md) concorde avec les en-têtes des ADR, et **nomme les articles que rien ne tient** : c'est la liste des gardes qui restent à écrire | `lint.yml` |

### Et un analyseur les lit tous (#4108)

Ces gardes sont elles-mêmes du shell, et le dépôt en compte **37 scripts** hors `node_modules`. Le
