...
| `verifie-chantier-de-l-issue.sh` | l'issue que la demande de fusion **ferme** appartient à un chantier : son `parent` n'est ni absent, ni le sas des suites #4562, d'où rien ne se traite. Il ne juge que cette issue-là, jamais le dépôt entier | `corps-pr.yml` (autotest : `lint.yml`) |
