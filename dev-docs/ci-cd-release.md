...
| [mutation-hebdo.yml](https://github.com/echonuit/vigiechiro-pr-companion/blob/main/.github/workflows/mutation-hebdo.yml) | hebdomadaire (lundi) + manuel | Mesure de mutation PIT sur les paquets `model`, **E2E exclus** : bilan dans le résumé du job, rapport détaillé en artefact | — |
