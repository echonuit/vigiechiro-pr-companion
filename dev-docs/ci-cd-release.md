...
| `scripts/adr/4617-code-mort-et-zone-de-test.py` | ce que le portail trouve sur les **deux** zones, cliquet à 62. Il lit le rapport de PMD et non les sources, refuse quand ce rapport manque plutôt que de rendre zéro, et écarte les littéraux dupliqués de la seule zone de test - où les répéter est le geste juste, et où ils font 1 366 des 1 428 signalements ([ADR 4617](decisions/4617-le-portail-voit-les-tests-et-le-code-mort.md)) | `lint.yml` |
