...
Tout est automatisé par **GitHub Actions**. Cette page cartographie les <!--inv:workflows-ci-->12<!--/inv--> workflows et le processus de
publication.
...
| [mutation-hebdo.yml](https://github.com/echonuit/vigiechiro-pr-companion/blob/main/.github/workflows/mutation-hebdo.yml) | hebdomadaire (lundi) + manuel | Mesure de mutation PIT sur **un paquet `model` par tour** (rotation sans état, cycle de 17 semaines), **E2E et `commun.api` exclus** : bilan dans le résumé du job, rapport détaillé en artefact | — |
| [mutation-ihm.yml](https://github.com/echonuit/vigiechiro-pr-companion/blob/main/.github/workflows/mutation-ihm.yml) | mensuel (le 8) + manuel | Mesure de mutation PIT sur les vues d'**une feature par tour** (rotation sans état, cycle de 15 mois), **E2E exclus** | — |
