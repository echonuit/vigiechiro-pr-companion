...
- **S2-01** · Le champ « Dossier source » est en lecture seule.
- **S2-02** · Le glisser-déposer d'un dossier est accepté.
- **S2-03** · L'inspection annonce le journal détecté (LogPR1925492).
- **S2-04** · L'inspection annonce le relevé climatique détecté.
- **S2-05** · L'inspection compte 6 originaux.
- **S2-06** · Aucun bandeau d'avertissement (cas nominal).
- **S2-07** · L'inspection annonce le renommage à venir (lecture seule, originaux intacts).
- **S2-08** · Le rattachement propose site, point, année, numéro.
- **S2-09** · La carte de confirmation montre le carré et le point choisi en indigo.
- **S2-10** · L'aperçu du préfixe `CarXXXXXX-AAAA-PassN-YY-` suit la saisie.
- **S2-11** · Le formulaire ne porte **plus** de case « Conserver les originaux » : le réglage a rejoint
...
- **S2-12** · « Importer cette nuit » affiche une barre de progression déterminée.
- **S2-13** · Une estimation de temps restant s'affiche.
- **S2-14** · Un bouton « Annuler » est disponible pendant l'import.
- **S2-15** · La table de suivi par fichier montre l'état de chaque wav (attente / copie / transformation /
  terminé).
- **S2-16** · Le formulaire est gelé pendant l'import.
- **S2-17** · Un message de succès conclut l'import.

**Étape 2 · Passage pivot (ouvert après l'import)**

- **S2-18** · Le stepper marque « Importé » et « Transformé » comme franchis (un passage naît au statut
  Transformé).
- **S2-19** · Une seule carte porte le liseré « recommandée » : Vérifier.
- **S2-20** · La carte « Sons & validation » est grisée.
- **S2-21** · Le grisé de « Sons & validation » est expliqué (tooltip ou « après dépôt »).
- **S2-22** · Le bandeau d'identité affiche date, plage horaire, enregistreur, statut, verdict.
- **S2-23** · Le résumé affiche volume bruts, volume transformé, durée, nombre de séquences.
- **S2-24** · « Voir la participation » est grisé (passage non lié) avec explication.
- **S2-25** · « 🗑 Supprimer » est actif (passage non déposé).
- **S2-26** · « ♻ Réactiver ce passage » est absent ou grisé quand l'audio est complet, avec explication.

**Étape 3 · Modale « Modifier le passage »**

- **S2-27** · Le libellé du bouton et le titre de la modale sont « Modifier le passage » (la doc dit « Modifier le
  rattachement » : S2-C04).
- **S2-28** · Les spinners Année et N° de passage fonctionnent.
- **S2-29** · La météo se saisit (températures, vent, couverture).
- **S2-30** · « Récupérer la météo » remplit les champs.
- **S2-31** · Le matériel micro se saisit (position, hauteur, type en liste fermée).
- **S2-32** · Le récapitulatif se met à jour en direct.
- **S2-33** · Changer le numéro de passage déclenche la confirmation de renommage disque (garde).
...
- **S2-34** · La courbe climatique T°/hygrométrie s'affiche, l'axe **gradué en heures**.
- **S2-35** · Les anomalies détectées s'affichent (ou leur placeholder).
- **S2-36** · Les évènements du journal s'affichent (ou leur placeholder).
- **S2-37** · La cohérence horaire indique la fenêtre nocturne (coucher/lever du soleil), avec l'alerte
  « hors nuit » si l'enregistrement déborde.
- **S2-38** · L'état GPS du **point d'écoute** est **toujours visible** : « disponible » ou « non renseigné
  (compléter la fiche site) ».
- **S2-39** · La **barre de statut** (bas de fenêtre) affiche l'enregistreur diagnostiqué et le **nombre de
  mesures climatiques**.

**Étape 5 · Cas dégradés (un import ou une inspection par fixture)**

- **S2-40** · `sd-melange` : bandeau « mélange » (2 enregistreurs), non bloquant.
- **S2-41** · `sd-incoherente` : bandeau « incohérence » journal↔wav (série et date), plus ferme.
- **S2-42** · `sd-multi-nuits` : la table des nuits apparaît (3 lignes, n° automatiques, cases Inclure).
- **S2-43** · `sd-multi-configs` : deux nuits, et le capteur a été **reconfiguré entre les deux** (384 kHz puis
...
- **S2-44** · `sd-sans-journal` : l'absence de journal est signalée, l'import reste possible (mode dégradé).
- **S2-45** · `sd-journal-corrompu` : l'inspection échoue avec un message compréhensible.
- **S2-46** · `sd-prefixee` : bandeau « discordance de préfixe » si le rattachement ne correspond pas.
- **S2-47** · `sd-rejets` : l'import aboutit malgré le faux wav, la zone des rejets liste « nom - raison ».
- **S2-48** · `sd-nominale.zip` : la décompression affiche sa barre et son bouton Annuler avant l'inspection.
- **S2-49** · Ré-inspection de `sd-nominale` : bandeau « nuit déjà importée », informatif.
- **S2-50** · Rattachement au même point + année + n° : bandeau « n° déjà pris » avec « Utiliser ce n° » et

**Bloc · Gestes de ligne (EPIC #1792)** : non automatisable (rendu du popup).

- **S2-51** · Pendant un import, clic droit sur une ligne du **suivi des fichiers** : le menu s'ouvre,
  entièrement lisible.
- **S2-52** · « Copier ▸ Nom du fichier » place le nom de l'enregistrement dans le presse-papier.
- **S2-53** · « Colonnes… » y figure **en dernier** ; la disposition choisie n'est **pas** mémorisée
...
- **S2-54** · Pendant la décompression d'un fichier de plusieurs Go, le **volume écrit défile** à côté du nom du
  fichier, alors que le compteur « X / N fichiers » reste immobile.
- **S2-55** · « Annuler » pendant ce fichier arrête la décompression **sans attendre la fin du fichier** : le
  retour à l'état neutre est perçu comme immédiat, pas au bout de plusieurs minutes.
- **S2-56** · Après cette annulation, aucun dossier `import-zip-*` ne subsiste dans le dossier de travail.
...
- **S2-57** · Une archive dont le contenu décompressé dépasse la place disponible est refusée **avant** que quoi
  que ce soit ne soit écrit ; le bandeau donne les deux volumes (nécessaire, disponible).
- **S2-58** · Le bandeau du refus est lisible **en entier** : la phrase qui dit quoi faire n'est pas tronquée.
...
- **S2-59** · 🔌 Connecté, importer une nuit : le compte rendu annonce une participation créée, **et** elle existe
  réellement sur la plateforme (« Voir la participation » l'ouvre). #3448
- **S2-60** · La même annonce dit **ce qu'il reste à faire** : « pensez à la compléter sur le portail (météo,
...
- **S2-61** · 🔒 Déconnecté, importer : le compte rendu **ne prétend pas** avoir créé de participation.
- **S2-62** · Rattacher une nuit dont des séquences doivent être renommées : le compte rendu **chiffre** les
  séquences renommées. #3449
- **S2-63** · 🔒 Faire échouer l'envoi (se déconnecter avant de valider) : le compte rendu dit **à la fois** le
  renommage réussi **et** l'échec de l'envoi, et non l'échec seul.
- **S2-64** · « 🗑 Supprimer » : la confirmation dit que les **fichiers audio restent sur le disque**, et affiche
  **où**. #3482
- **S2-65** · Après confirmation, regarder le disque : le dossier de la nuit est **toujours là**, conformément à
