...
#
# ⚠️ Le second n'a été trouvé que parce que le premier venait de l'être. Rien ne garantissait qu'on
...
part_changee() {
  ...
  # ⚠️ Le PREMIER MOT, lu par `awk` - pas un découpage sur les chiffres. Au-delà d'un million de pixels
  ...
  # ⚠️ `%w %h` et non `%[fx:w*h]`, même piège à l'autre bout du calcul : sur une toile de 1280 × 900 le
