...
/// Cellule-bouton de la liste de tri (#370) : préfixe « Tri : » devant l'ordre **sélectionné**,
/// sans toucher aux items du menu déroulant (qui restent bruts, via le converter). Remplace
/// l'ancienne étiquette « Tri : » posée avant la liste.
