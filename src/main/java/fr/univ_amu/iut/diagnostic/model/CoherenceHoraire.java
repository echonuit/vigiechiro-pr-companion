...
///
/// Ce type ne dit que ce que les **horaires** montrent. La nuit interrompue est l'autre axe, persisté
/// depuis #5093 et porté par son propre encart : deux questions, deux réponses.
///
...
/// @param debutTenu l'enregistrement commence assez tôt pour le début de la fenêtre exigée
/// @param finTenue l'enregistrement va assez loin pour la fin de la fenêtre exigée
...
public record CoherenceHoraire(
    ...
    private static final CoherenceHoraire INDISPONIBLE =
            new CoherenceHoraire(false, null, null, null, null, null, null, false, false, Couverture.INDISPONIBLE);
