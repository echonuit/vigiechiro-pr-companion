...
/// @param carre numéro de carré du site de rattachement
/// @param codePoint code du point d'écoute de rattachement
public record PassageExistant(int numeroPassage, int annee, String carre, String codePoint) {}
