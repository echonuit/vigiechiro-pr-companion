...
public enum CategorieConstat {
    ...
    DEPOT_DIVERGENT("Nom divergent après dépôt"),
    /// Un passage n'a aucune session d'enregistrement (jamais importé).
    SESSION_ABSENTE("Passage jamais importé"),
    ...
    AUDIO_INDISPONIBLE("Audio incomplet"),
    ...
    CategorieConstat(String libelle) {
        this.libelle = libelle;
    }

    /// Le nom **lisible** de la catégorie (#3100), tiré de la description de chaque constante.
    ///
    /// La table affichait `name()` : « PREFIXE_NON_CONFORME » se lit comme un identifiant de code,
    /// pas comme un constat adressé à un naturaliste.
