...
///
/// Ce socle porte ce geste, pas la **politique de bornes** : le Diagnostic cale son axe sur l'étendue de
/// ses mesures, l'Activité impose un cadre fixe de 18 h à 8 h pour que deux nuits se comparent. Deux
/// intentions différentes, qui restent chez leurs écrans respectifs — les fondre ici les rendrait moins
/// lisibles, pas plus.
public final class AxeHoraire {

    /// Format d'étiquette : l'heure seule (`22`), la minute n'ayant pas de place sur une graduation.
    ...
    /// @param pasMinutes intervalle entre deux graduations, en minutes
    public static void graduerEnHeures(NumberAxis axe, LocalTime origine, double etendueMinutes, double pasMinutes) {
        ...
        axe.setTickLabelFormatter(etiquettesHeure(origine));
    }
    ...
    public static StringConverter<Number> etiquettesHeure(LocalTime origine) {
