...
public class RattachementModaleController {
  ...
  private void initialize() {
    spinnerAnnee.setValueFactory(
        new SpinnerValueFactory.IntegerSpinnerValueFactory(2000, 2100, 2026));
    spinnerNumero.setValueFactory(new SpinnerValueFactory.IntegerSpinnerValueFactory(1, 99, 1));
