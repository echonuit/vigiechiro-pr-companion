...
setup() {
  # Le verdict des cas de couleur depend de ces entrees. Les heriter du poste fait echouer les cas
  # qui attendent de l ANSI avant meme qu ils aient pose la variable qu ils eprouvent (#5512).
