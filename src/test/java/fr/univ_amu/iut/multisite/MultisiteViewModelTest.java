...
class MultisiteViewModelTest {
    ...
    private final ServiceCommunes communes = mock(ServiceCommunes.class);
    ...
    void charger_appliquer_signaler_separes() {
        ...
        MultisiteViewModel vm = new MultisiteViewModel(service, serviceSites, communes, Optional.empty(), ID);
    ...
    void releve_disponible_seulement_connecte() {
        assertThat(new MultisiteViewModel(service, serviceSites, communes, Optional.empty(), ID)
                        .releveAnalysesDisponible())
                .isFalse();
        assertThat(new MultisiteViewModel(service, serviceSites, communes, Optional.of(mock(SuiviTraitement.class)), ID)
                        .releveAnalysesDisponible())
                .isTrue();
    }
