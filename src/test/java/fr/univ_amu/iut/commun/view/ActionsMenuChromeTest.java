...
class ActionsMenuChromeTest {
    ...
    void entree_sauvegarder() {
        ActionSauvegarder entree =
                new ActionSauvegarder(sauvegarde, navigateur, occupation, SelecteursDeTest.auDefaut());
    ...
    void entree_sauvegarder_complet() {
        ActionSauvegarderComplet entree =
                new ActionSauvegarderComplet(sauvegarde, navigateur, occupation, SelecteursDeTest.auDefaut());
        neutraliserDialogues(entree.porteur().actions(), DOSSIER);
    ...
    void entree_restaurer() {
        ActionRestaurer entree = new ActionRestaurer(sauvegarde, navigateur, occupation, SelecteursDeTest.auDefaut());
    ...
    void entree_restaurer_complet() {
        ...
        ActionRestaurerComplet entree =
                new ActionRestaurerComplet(sauvegarde, navigateur, occupation, SelecteursDeTest.auDefaut());
        neutraliserDialogues(entree.porteur().actions(), DOSSIER);
