    ...
    void progression_ancrage_sur_sortie_erreur() {
        ...
        when(moteur.publier(eq(42L), any(), any())).thenAnswer(invocation -> {
            ...
            progres.accept(new Progression(
                    "Récupération des identifiants et des échanges avec le validateur… (page 3/48)", 0.06));
        ...
        assertThat(code).isZero();
        assertThat(erreurs.toString())
                .contains("Récupération des identifiants et des échanges avec le validateur… (page 3/48)");
        assertThat(sortie.toString())
