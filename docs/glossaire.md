...
| **Nuit biologique** | La nuit telle que la vivent les chauves-souris : du crépuscule à l'aube, donc **à cheval sur deux dates**. L'application y rattache un enregistrement par **bascule à midi** — un contact capté à 2 h du matin le 22 juin appartient à la nuit du 21. C'est vrai à l'écran [Activité de la nuit](ecrans/activite.md) comme dans les exports. |
...
| **Statut** | Étape d'avancement d'un passage dans le traitement : Importé, Transformé, Vérifié, Prêt à déposer, Dépôt en cours, Déposé. Plus **Récupéré**, qui n'est pas une étape : c'est une nuit que la synchronisation a rapportée de Vigie-Chiro, avec ses observations mais sans son audio. Elle rejoint « Déposé » quand la réactivation le lui rend. |
