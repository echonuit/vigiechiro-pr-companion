...
![L'écran Réglages : un onglet par domaine (Général, Import).](../assets/captures/apercu-reglages.png)
...
Une modification est **enregistrée immédiatement** et **conservée d'une session à l'autre**.
