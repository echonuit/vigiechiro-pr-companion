...
Les passes **1 à 9 gardent leur numéro** : 35 des 42 citations de passes du dépôt vivent dans des ADR **immuables**. Les deux passes ajoutées sont donc aux extrémités.
